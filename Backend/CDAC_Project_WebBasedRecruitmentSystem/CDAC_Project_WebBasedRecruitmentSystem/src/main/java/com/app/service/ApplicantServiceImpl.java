...
//	}
	...
	public ApplicantResponse getProfileInfo() {
	    ...
	    // Map the ApplicantEntity to ApplicantResponse
	    ApplicantResponse response = mapper.map(applicant, ApplicantResponse.class);
	    
	    // Set the resume and profile picture links directly from the entity
	    response.setResumeLink(applicant.getResumeLink());
	    response.setProfilePictureLink(applicant.getProfilePictureLink());
